...
function OpacityChild({
    ...
    const opacity = useTransform(progress, [index / total, (index + 1) / total], [0, 1]);
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "storybook-fix relative h-96 w-full overflow-y-scroll bg-foreground bg-white text-background dark:text-zinc-900",
                className,
            )}
        >
